...
#    And the response should contain the message "Email already exists"
#    And the user should not be saved in the database again
#
...
#    When I submit the registration form
#    Then I should receive a response with status code 409
#    And the response should contain the message "CPF already exists"
#    And the user should not be saved in the database again
#
...
#    And the user should not be saved in the database
